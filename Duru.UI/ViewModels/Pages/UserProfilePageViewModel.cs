...
public partial class UserProfileViewModel : ObservableObject
{
    ...
    [ObservableProperty] private bool _isPasswordChangeVisible;
    ...
    private async Task SaveChanges()
    {
        ...
        if (!string.IsNullOrWhiteSpace(Email) && !Email.Contains("@"))
        {
            await _dialogCoordinator.ShowMessageAsync(
                this, "Geçersiz E-posta", "Lütfen geçerli bir e-posta adresi girin.", MessageDialogStyle.Affirmative,
                new MetroDialogSettings { AffirmativeButtonText = "Tamam" });
            return;
        }

        var result = await _dialogCoordinator.ShowMessageAsync(
            this, "Değişiklikleri Kaydet",
            "Profil bilgilerinizde yapılan değişiklikleri kaydetmek istediğinize emin misiniz?",
        ...
        var progress = await _dialogCoordinator.ShowProgressAsync(
            this, "Kaydediliyor...", "Profil bilgileriniz güncelleniyor...");
        ...
        Debug.WriteLine($"Kaydedilen Ad Soyad: {FullName}");
        Debug.WriteLine($"Kaydedilen E-posta: {Email}");
        Debug.WriteLine($"Kaydedilen Telefon: {PhoneNumber}");
    ...
    private async Task ChangePassword()
    {
        ...
        {
            await _dialogCoordinator.ShowMessageAsync(
                this, "Eksik Bilgi", "Lütfen tüm şifre alanlarını doldurun.", MessageDialogStyle.Affirmative,
                new MetroDialogSettings { AffirmativeButtonText = "Tamam" });
            return;
        }
        ...
        {
            await _dialogCoordinator.ShowMessageAsync(
                this, "Geçersiz Şifre", "Yeni şifre en az 6 karakter olmalıdır.", MessageDialogStyle.Affirmative,
                new MetroDialogSettings { AffirmativeButtonText = "Tamam" });
            return;
        }
        ...
        {
            await _dialogCoordinator.ShowMessageAsync(
                this, "Şifreler Uyuşmuyor", "Yeni şifre ve tekrarı aynı değil.", MessageDialogStyle.Affirmative,
                new MetroDialogSettings { AffirmativeButtonText = "Tamam" });
            return;
        }
        ...
        var isCurrentPasswordValid = CurrentPassword == "123456"; // Simülasyon: Mevcut şifre "123456" olsun

        if (!isCurrentPasswordValid)
        {
            await _dialogCoordinator.ShowMessageAsync(
                this, "Hatalı Şifre", "Girdiğiniz mevcut şifre yanlış.", MessageDialogStyle.Affirmative,
                new MetroDialogSettings { AffirmativeButtonText = "Tamam" });
            return;
        }
        ...
        var result = await _dialogCoordinator.ShowMessageAsync(
            this, "Şifre Değiştirme Onayı",
            "Şifrenizi değiştirmek istediğinize emin misiniz? Bu işlemden sonra yeni şifrenizle giriş yapmanız gerekecektir.",
            MessageDialogStyle.AffirmativeAndNegative,
            new MetroDialogSettings { AffirmativeButtonText = "Evet, Değiştir", NegativeButtonText = "İptal" });
        ...
        {
            await _dialogCoordinator.ShowMessageAsync(
                this, "Hata", "Şifre değiştirilirken bir sorun oluştu. Lütfen tekrar deneyin.");
        }
        // ------------------------------------------
    }
